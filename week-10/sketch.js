...
function setup() {  // this function runs only once while running
    ...
    specs = loadImage('https://brianclarkinteractive.github.io/accd-mdes-sem1/week-10/images/Brian-Clark-Head.png');
}
...
let eyeDist = dist(singlePose.leftEye.x, singlePose.leftEye.y, singlePose.rightEye.x, singlePose.rightEye.y)

        // Apply specs and cigar
        image(specs, singlePose.nose.x-95, singlePose.nose.y-120, eyeDist*4,eyeDist*4);
    }
